...
```{r lemh-temp-redd-map, fig.cap = "Map of Lemhi River showing modeled stream temperatures during spawning for Chinook salmon and the distribution of redds (small, open black circles) available from redd surveys in recent years. Modeled temperatures are predictions for August 29 averaged across years where predictions are available."}
...
```{r lemh-redd-map-by-year, fig.cap = "Same as figure above, except faceted by survey year to show years for which data are available and how the spatial distribution of redds potentially changed."}
